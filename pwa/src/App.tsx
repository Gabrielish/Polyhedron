...
export function App(): React.JSX.Element {
  ...
  useEffect(() => {
    if (!googleClientId || window.localStorage.getItem(DRIVE_CONNECTED_KEY) !== 'true') {
      setAuthReady(true)
      return
    }
  ...
  if (!authReady) return <main className="app-shell">    <header className="app-header">
    ...
    </header><section className="connect-screen"><p>Connecting to Google Drive…</p></section></main>
