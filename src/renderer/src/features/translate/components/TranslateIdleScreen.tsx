  ...
  return (
    <>
      <div className="translate-idle-shell relative flex h-full min-h-0 flex-col">
        <header className="translate-idle-header shrink-0 border-b border-[#1f2329] bg-[#101114] px-6 py-4">
        ...
        <div className="translate-idle-footer shrink-0 pb-1 pt-3">
          <div className="translate-idle-footer-panel mx-auto flex w-full max-w-220 items-center gap-2.5 rounded-xl border border-neutral-800/80 bg-[#141416] px-4 py-3 shadow-xl">
